...
must_haves:
  ...
  artifacts:
    - path: "frontend/src/pages/LoginPage.tsx"
      provides: "Working login form that authenticates against Payload CMS"
    - path: "frontend/src/pages/DashboardPage.tsx"
      provides: "Event list with status badges and navigation"
    - path: "frontend/src/pages/EventCreatePage.tsx"
      provides: "Event creation form with all required fields"
    - path: "frontend/src/pages/EventDetailPage.tsx"
      provides: "Event detail with participants, status controls, and attendance"
    - path: "frontend/src/hooks/use-events.ts"
      provides: "Event CRUD hooks connecting UI to Payload API"
    ...
    - path: "frontend/src/mocks/handlers.ts"
      provides: "MSW mock for SIMV search in development"
    - path: "backend/src/collections/Events.ts"
      provides: "Events collection with status field and transition validation"
  key_links:
    ...
    - from: "frontend/src/pages/EventDetailPage.tsx"
      to: "/api/events"
      via: "useEvent query and useUpdateEvent mutation"
      pattern: "useEvent|useUpdateEvent"
    - from: "frontend/src/pages/EventDetailPage.tsx"
      to: "frontend/src/hooks/use-participants.ts"
      via: "useSimvSearch, useAddParticipant, useRemoveParticipant"
      pattern: "useSimvSearch|useAddParticipant|useRemoveParticipant"
    - from: "frontend/src/hooks/use-auth.ts"
      to: "/api/users/login"
      via: "POST fetch for authentication"
